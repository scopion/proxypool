...
r = redis.Redis(host="10.251.46.109", port=7001,db=0)
iplist= r.hkeys("proxyPool_slave_v4")
print iplist
orilist = []
...
print len(iplist)
if (len(iplist) < 200 ):
	send_mail(mailto_list,"代理池报警","len(iplist)请登录机器139查看")
